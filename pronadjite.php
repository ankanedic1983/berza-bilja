<html>
<head>
<title>Berza bilja: Pronađite</title>
...
<p>Biljka: <input type="text" name="biljka"></p>
<p>Lokacija: <input type="text" name="lokacija"></p>
<p>Ako ostavite polje biljka prazno izlistace se sve biljke</p>
<p>Ako ostavite polje lokacija prazno izlistace se sve lokacije</p>
